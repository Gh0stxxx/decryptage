...
selection_methode_decryptage = function(qualite_texte_crypte, texte_crypte, alphabets_matrice_selection_ordonnees){
...
metropolis = function(texte_crypte,texte_decrypte,qualite_texte_crypte,qualite_texte_decrypte) {
   if (qualite_texte_decrypte >= qualite_texte_crypte) {
        ...
        return(texte_decrypte)
     } else if ( runif(1) < exp(qualite_texte_decrypte - qualite_texte_crypte) ) {
        return(texte_decrypte)
     } else {
        return(texte_crypte)
   }
...
alphabets_corpus = extraction_alphabets(corpus)
  ...
  nombre_de_lettre_a_garder = 40  #paramatre
...
texte_a_crypter = ".i am the and we for of this what then a now "
