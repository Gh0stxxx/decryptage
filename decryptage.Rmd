...
texte=" do you think we are what we have for the others, and with he she is in a of or not know says this that when who to gone "
...
if(l%%100==0){
cat("n = ",l,"\n")
cat("Original : ",texte,"    ",proba_texte,"\n")
cat("Courant  : ",texte_crypte,"    ",proba(texte_crypte,matrice_apprentissage),"\n")
cat("meilleur : ",best[[1]],"    ",best[[2]],"\n\n")
}
