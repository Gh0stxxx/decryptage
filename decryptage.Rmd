...
ui<-fluidPage(
  inputPanel(
  selectInput("n_iterations", label = "Number of iterations:",
...
texte=str_sub(texte_apprentissage,1000,1500)
texte=str_to_lower(texte)
...
if(l%%100==1){
cat("n = ",l,"\n\n")
cat("Original : ",proba_texte,"\n",texte,"\n\n")
#cat("Crypte   : ","\n",texte_crypte_initial,"\n\n")
cat("Courant  : ",p,"\n",texte_crypte,"\n\n")
cat("meilleur : ",best[[2]],"\n",best[[1]],"\n","\n\n\n")
if(p>proba_texte){print("le texte n'est pas un minimum global \n")}
}
}
```
