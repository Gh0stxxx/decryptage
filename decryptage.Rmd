...
texte_a_crypte = ".i am the and we for of this what then a now "
texte_crypte = cryptage(texte_a_crypte, names(alphabets_matrice_selection_ordonnees))
```
...
calcul_qualite = calcul_qualite_log
