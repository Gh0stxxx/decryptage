...
ui <- fluidPage(
  ...
  inputPanel(
        textAreaInput("texte_a_crypter", "Texte à crypter","je tu ils nous vous ils donc pour tes ces les and you to be this for.",width = 885, height = 200)
...
h3("Decryptage"),
  inputPanel(
        textAreaInput("texte_a_decrypter", "Texte à decrypter","je tu ils nous vous ils donc pour tes ces les and you to be this for.",width = 885, height = 200)),
