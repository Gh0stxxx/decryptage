...
library(shiny)
library(rclipboard)
load("~/Documents/decryptage backup/decryptage/environnement.RData")
...
ui <- fluidPage(
  rclipboardSetup(),
    inputPanel(
        ...
        textInput("texte_a_crypter", "Texte à crypter", "Enter your text here"),
        uiOutput("clip"),
        textInput("texte_a_decrypter", "Texte à decrypter", "Enter your text here"),
    ...
    tabsetPanel(type = "tabs",
                tabPanel("texte crypté", textOutput("texte_crypte")),
                tabPanel("texte courant", textOutput("texte_courant")),
                tabPanel("texte decrypté", textOutput("texte_decrypte"))
    )
)
