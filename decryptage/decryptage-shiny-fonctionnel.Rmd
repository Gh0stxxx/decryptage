...
ui <- fluidPage(
  rclipboardSetup(),
    inputPanel(
        ...
        sliderInput("n_iterations_metropolis", "Nombre d'iterations metropolis", min=10, max=50000, value=5000, step= 500)
    ),
  inputPanel(
        textAreaInput("texte_a_crypter", "Texte à crypter","Enter your text here : you know caius marcius is chief enemy to the people. all: we know't, we know't. first citizen: let us kill him, and we'll have corn at our own price. is't a verdict? all: no more talking on't let it be done: away, away! second citizen: one word good citizens."),
        actionButton("go_cryptage", "Crypter !"),
        uiOutput("clip")
    ),
  inputPanel(
        textAreaInput("texte_a_decrypter", "Texte à decrypter", "Enter your text here : you know caius marcius is chief enemy to the people. all: we know't, we know't. first citizen: let us kill him, and we'll have corn at our own price. is't a verdict? all: no more talking on't let it be done: away, away! second citizen: one word good citizens."),
