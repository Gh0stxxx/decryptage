...
ui <- fluidPage(
  ...
  inputPanel(
    textAreaInput("texte_a_crypter", "Texte à crypter","Enter your text here : In statistics and statistical physics, the Metropolis–Hastings algorithm is a Markov chain Monte Carlo method for obtaining a sequence of random samples from a probability distribution from which direct sampling is difficult. This sequence can be used to approximate the distribution or to compute an integral. Metropolis–Hastings and other MCMC algorithms are generally used for sampling from multi-dimensional distributions, especially when the number of dimensions is high. For single-dimensional distributions, there are usually other methods that can directly return independent samples from the distribution, and these are free from the problem of autocorrelated samples that is inherent in MCMC methods.",width = 860, height = 200)
  ),
  ...
  inputPanel("Texte crypté", div(textOutput("texte_crypte"), class="form-control shiny-bound-input", style="width: 860px; height: 190px; position:relative ; right: 232px; top: 20px; color: grey ; font-weight : bold"), class="shiny-input-panel", style="font-weight:bold"
  ),
  inputPanel(
    uiOutput("clip")
  ),
