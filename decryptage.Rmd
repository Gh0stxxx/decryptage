...
algo_metropolis = function(texte_crypte,texte_decrypte,qualite_texte_crypte,qualite_texte_decrypte) {
...
##Anglais : monogrammes avec espace
...
alphabets_matrice_selection_ordonnees = unlist(data[][2])
names(alphabets_matrice_selection_ordonnees) = unlist(data[][1])
...
calcul_qualite = calcul_qualite_multiplication
...
for(iteration in 1:nombre_iterations_max){
  ...
  texte_crypte = algo_metropolis(texte_crypte, texte_decrypte, qualite_texte_crypte, qualite_texte_decrypte)
